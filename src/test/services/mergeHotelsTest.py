...
from app.schemas.suppliers.paperfliesSupplierSchema import PaperfliesSupplierSchema
from app.schemas.suppliers.acmeSupplierSchema import AcmeSupplierSchema
from app.schemas.suppliers.patagoniaSupplierSchema import PatagoniaSupplierSchema

acme_hotel = AcmeSupplierSchema(**{
    "Id": "iJhz",
    "DestinationId": 5432,
...
patagonia_hotel = PatagoniaSupplierSchema(**{
    "id": "iJhz",
    "destination": 5432,
    "name": "Beach Villas Singapore",
    "lat": 1.264751,
...
paperflies_hotel = PaperfliesSupplierSchema(**{
    "hotel_id": "iJhz",
    "destination_id": 5432,
...
print(MergeHotels.merge_hotels(
    hotel_ids=["iJhz", "SjyX"], destination_id=5432))
...
#       patagonia_hotel=patagonia_hotel, paperflies_hotel=paperflies_hotel))
# print(MergeHotels.merge_booking_conditions_data(acme_hotel=acme_hotel,
#       patagonia_hotel=patagonia_hotel, paperflies_hotel=paperflies_hotel))
